...
from data.datasets import HuggingFaceDataset
...
def make_train_dataset(args, tokenizer, accelerator):
    ...
    if args.dataset_name is not None:
        ...
        dataset = HuggingFaceDataset(train_image_dir,train_label_dir,h,w,palette,transform=img_transforms,target_transform=label_transforms)
    else:
